...
menu_options = {
    {name = "Imbracaminte", f = customise, param = nil},
    {name = "Accesorii", f = accessories, param = nil},
    {name = "Fata", f = overlays, param = nil},
    ...
    {name = "Genero", f = listModels, param = freemode_models},
}
player_data  = {
...
local clothing_shops = {
    {name="Clothing Store", id=73, x=614.208, y=2767.779, z=42.088}, -- ,,
    {name="Clothing Store", id=73, x=75.399, y=-1392.795, z=29.376}, -- 75.399620056152,-1392.7951660156,29.376131057739
    ...
    {name="Clothing Store", id=73, x=-1457.059, y=-241.105, z=49.805},-- -1457.0596923828,-241.10504150391,49.805568695068
    {name="Clothing Store", id=73, x=-158.399, y=-296.869, z=39.733}, -- -158.39933776855,-296.869140625,39.73327255249
    {name="Clothing Store", id=73, x=-3173.093, y=1038.742, z=20.863}, -- -3173.09375,1038.7426757813,20.863216400146
    {name="Clothing Store", id=73, x=-1108.451, y=2708.897, z=19.107}, -- -1108.4516601563,2708.8972167969,19.107870101929
    {name="Clothing Store", id=73, x=614.219, y=2767.813, z=42.088}, -- 614.21978759766,2767.8137207031,42.088096618652
    {name="Clothing Store", id=73, x=1190.422, y=2713.544, z=38.222}, -- 1190.4226074219,2713.5444335938,38.222633361816
    {name="Clothing Store", id=73, x=1696.367, y=4829.349, z=42.063}, -- 1696.3674316406,4829.3491210938,42.063125610352
            ...
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                ...
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
                    if (incircle == false) then
                        DisplayHelpText("Apasa ~INPUT_CONTEXT~ sa intrii la magazinul de haine.")
                    end
                    incircle = true
