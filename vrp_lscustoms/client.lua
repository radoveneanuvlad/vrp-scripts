...
local lsc = {
	...
	,["primarymetallic"] = { 
		...
		["windows"] = { 
			...
			buttons = { 
				...
				{name = "Darksmoke",tint = 2, costs = 1200, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lightsmoke",tint = 3, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Limo",tint = 4, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Green",tint = 5, costs = 600, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["wheelaccessories"] = { 
			...
			buttons = { 
				...
				{name = "Bulletproof Tires", costs = 2000, description = "", centre = 0, font = 0, scale = 0.4},
		...
		["secondaryclassic"] = { 
			...
			buttons = { 
				...
				{name = "Lowered Suspension",mod = false,modtype =15, costs = 1250, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Street Suspension",mod = 1,modtype =15, costs = 1450, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sport Suspension",mod = 2,modtype =15, costs = 1600, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Competition Suspension",mod = 3,modtype =15, costs = 1800, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["transmission"] = { 
			title = "transmissions", 
			...
			buttons = { 
				...
				{name = "Street Transmission",mod = false,modtype =13, costs = 1200, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sports Transmission",mod = 1,modtype =13, costs = 1800, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Race Transmission",mod = 2,modtype =13, costs = 2100, description = "", centre = 0, font = 0, scale = 0.4}
			}
		}
		,
		["turbo"] = { 
			...
			buttons = { 
				...
				{name = "Turbo Tuning",mod = true,modtype =18, costs = 5100, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["wheels"] = { 
			title = "wheels", 
		...
		["neoncolor"] = { 
			...
			buttons = { 
				...
				{name = "Blue", color = {0,0,255}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Electric Blue", color = {0,150,255}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Mint Green", color = {50,255,155}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lime Green", color = {0,255,0}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Yellow", color = {255,255,0}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Golden Shower", color = {204,204,0}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Orange", color = {255,128,0}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Red", color = {255,0,0}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pony Pink", color = {255,102,255}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Hot Pink", color = {255,0,255}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Purple", color = {153,0,153}, costs = 1000, description = "", centre = 0, font = 0, scale = 0.4},
			}
		},
		["headlights"] = { 
			title = "headlights", 
	...
	["nitro"] = { 
		...
		name = "nitro",
		buttons = { 
			{name = "None",mod = false,nos = 0, costs = 302, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Nitro Mk1",mod = true,nos = 1, costs = 750000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Nitro Mk2",mod = true,nos = 2, costs = 900000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Nitro Mk3",mod = true,nos = 3, costs = 1200000, description = "", centre = 0, font = 0, scale = 0.4}
		}
	},
	["brakes"] = { 
		title = "brakes", 
		...
		buttons = { 
			...
			{name = "Street Brakes",modtype = 12, mod = false, costs = 700, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Sport Brakes",modtype = 12, mod = 1, costs = 950, description = "", centre = 0, font = 0, scale = 0.4},
	...
	["engine"] = { 
		...
		buttons = { 
			...
			{name = "EMS Upgrade, Level 2",modtype = 11, mod = false, costs = 1500, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 3",modtype = 11, mod = 1, costs = 2000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 4",modtype = 11, mod = 2, costs = 3000, description = "", centre = 0, font = 0, scale = 0.4}
		}
	},
	["horn"] = { 
			title = "horns", 
